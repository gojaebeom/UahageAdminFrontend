    ...
    <div className="mb-4">
        <div className="shadow-lg rounded-2xl p-4 bg-white dark:bg-gray-700 w-full">
            ...
            <div className="flex -space-x-2">
                <a className="">
                    <img className="inline-block h-10 w-10 rounded-full object-cover ring-2 ring-white" src={profileImage} alt="Guy"/>
                </a>
                <a className="">
                    <img className="inline-block h-10 w-10 rounded-full object-cover ring-2 ring-white" src={profileImage} alt="Max"/>
                </a>
                <a className="">
                    <img className="inline-block h-10 w-10 rounded-full object-cover ring-2 ring-white" src={profileImage} alt="Charles"/>
                </a>
                <a className="">
                    <img className="inline-block h-10 w-10 rounded-full object-cover ring-2 ring-white" src={profileImage} alt="Jade"/>
                </a>
            </div>
